#
#  Be sure to run `pod spec lint MovingPictures.podspec' to ensure this is a
...
and the exporting file format.
  ...
  # Or just: s.author    = "tsabend"
  # s.authors            = { "tsabend" => "tsabend@gmail.com" }
  # s.social_media_url   = "http://twitter.com/tsabend"
  ...
  s.source       = { :git => "https://github.com/tsabend/MovingPictures.git", :tag => "0.0.1" }
